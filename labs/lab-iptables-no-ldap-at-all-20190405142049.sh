...
#        iptables -A INPUT -p tcp -s 147.52.78.6 --sport 390 -j ACCEPT
	...
	### polygon:
	#iptables -A INPUT  -s 147.52.82.72  -p tcp --sport 80 -j REJECT
	#iptables -A INPUT  -s 147.52.82.72  -p tcp --sport 443 -j REJECT
	#iptables -A OUTPUT -d 147.52.82.72  -p tcp --dport 80 -j REJECT
	#iptables -A OUTPUT -d 147.52.82.72  -p tcp --dport 443 -j REJECT
	...
	### mathjax:
        iptables -A INPUT  -s 104.19.195.151  -j ACCEPT
        iptables -A INPUT  -s 104.19.196.151  -j ACCEPT
        iptables -A INPUT  -s 104.19.197.151  -j ACCEPT
        iptables -A INPUT  -s 104.19.198.151  -j ACCEPT
        iptables -A INPUT  -s 104.19.199.151  -j ACCEPT
        iptables -A OUTPUT  -d 104.19.195.151  -j ACCEPT
        iptables -A OUTPUT  -d 104.19.196.151  -j ACCEPT
        iptables -A OUTPUT  -d 104.19.197.151  -j ACCEPT
        iptables -A OUTPUT  -d 104.19.198.151  -j ACCEPT
        iptables -A OUTPUT  -d 104.19.199.151  -j ACCEPT
	#### fourier:
        #iptables -A INPUT  -s 147.52.65.68  -j ACCEPT
        #iptables -A OUTPUT -d 147.52.65.68  -j ACCEPT
	#### users:
        #iptables -A INPUT  -s 147.52.48.134  -j ACCEPT
        #iptables -A OUTPUT -d 147.52.48.134  -j ACCEPT
	#### maerts:
        #iptables -A INPUT  -s 147.52.48.136  -j ACCEPT
        #iptables -A OUTPUT -d 147.52.48.136  -j ACCEPT
	#### romeo:
        #iptables -A INPUT  -s 147.52.48.135  -j ACCEPT
        #iptables -A OUTPUT -d 147.52.48.135  -j ACCEPT
###	### euler:
